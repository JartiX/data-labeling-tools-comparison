...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Проверка PNG файлов в директории.")
    ...
    parser.add_argument("--file", type=str, help="Путь к одному PNG файлу для проверки.")
